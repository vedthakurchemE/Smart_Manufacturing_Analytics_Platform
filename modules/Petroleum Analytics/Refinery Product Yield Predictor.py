...
def run():
    ...
    st.markdown("Upload your crude assay dataset and predict yields of gasoline, diesel, and LPG.")

    st.sidebar.header("📂 Upload Crude Assay Dataset")
    ...
    if uploaded_file:
        ...
        # Auto-select features and targets
        ...
        st.info("📎 Please upload a CSV file containing crude assay and product yield data.")
